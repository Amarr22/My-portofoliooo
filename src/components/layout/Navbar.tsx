...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 mix-blend-difference px-6 py-6 lg:px-12 lg:py-8 flex justify-between items-center text-white">
      ...
      >
        <span className="text-xs font-medium uppercase tracking-widest opacity-70">Amar</span>
        <span className="text-2xl font-bold uppercase tracking-tighter">Portfolio</span>
      </motion.a>
