  ...
  return (
    <section id="contact" className="py-48 px-6 lg:px-12 bg-foreground text-background relative overflow-hidden">
      ...
      <div className="container mx-auto flex flex-col items-center text-center">
        ...
        >
          <h2 className="leading-none text-primary font-black uppercase" style={{ fontSize: 'clamp(4rem, 15vw, 14rem)', letterSpacing: '-0.02em' }}>
            HAVE A<br />IDEA?
          </h2>
          
          <a
            href="https://t.me/Kakakoko12"
            target="_blank"
        ...
        <div className="w-full mt-32 grid grid-cols-2 md:grid-cols-4 gap-12 pt-12 border-t border-background/20 text-xs font-bold uppercase tracking-[0.2em]">
          <div className="flex flex-col gap-4">
            ...
            <a href="https://www.instagram.com/0xamarr.eth/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">Instagram</a>
          ...
          <div className="col-span-2 flex flex-col items-end justify-end gap-2 text-right">
            <span className="text-primary">IDEATE × BUILD × DEPLOY</span>
            <span className="opacity-50">Made by Amarr</span>
          </div>
        </div>
      </div>
    </section>
