      ...
      <div className="container mx-auto">
        ...
        >
          <h1 className="text-kinetic leading-none flex flex-col">
            <span>Web 3</span>
            <span className="self-end">Contributor</span>
          </h1>
          ...
          <div className="mt-8 flex flex-col md:flex-row justify-between items-end gap-8">
            <p className="max-w-md text-lg md:text-xl font-body text-muted-foreground">
              I am contributor to various Web3 projects. I mainly focus on making high-quality, original and insightful content on X.
            </p>
            ...
            >
              ...
              <span className="uppercase tracking-widest text-sm font-bold">Based in Indonesia</span>
            </motion.div>
          </div>
        </motion.div>
      </div>
